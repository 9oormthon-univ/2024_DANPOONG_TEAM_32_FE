			...
			<div className="w-full grid grid-cols-3 gap-2 p-3 rounded-3xl">
				{welfareItems.map((item, index) => (
					<div
						...
						className="aspect-square py-2 flex flex-col justify-center items-center border-2 border-gray rounded-2xl cursor-pointer">
						<div className="flex flex-col items-center justify-center">
							<div className="w-12 h-12">{item.element}</div>
						</div>
